...
echo Consulte o manual do comando seq
for i in $(seq 0 2)
do
	echo $i
done
...
echo como input todos os ficheiros presentes napasta inputs.
echo NOTA: Para que o scriptfuncione, tem de ser executado
